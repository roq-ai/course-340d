...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'course.create': {
    roles: ['course-creator', 'course-instructor'],
    key: 'course-created',
  ...
  'lesson.create': {
    roles: ['course-creator', 'course-instructor'],
    key: 'lesson-contributed',
    tenantPath: ['organization', 'course', 'lesson'],
    userPath: [],
  },
  'lesson.update': {
    roles: ['course-creator', 'course-instructor'],
...
const tenantRoles: string[] = ['course-creator', 'course-instructor'];
